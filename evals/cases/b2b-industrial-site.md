...
2. **Config generation**: Creates `site.config.json` with all required fields
...
9. **Publish review**: Produced before deployment, lists files and claims needing confirmation
...
- [ ] `site.config.json` created with brand, products, domain, design, publishing policy
...
- [ ] Publish review lists files, new pages, claims needing confirmation
